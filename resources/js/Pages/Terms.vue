...
<template>
    <Head title="Terms of Service — NexaHub" />
            ...
            <main class="min-w-0">
                ...
                <div class="mb-12 pb-8 border-b border-slate-100 dark:border-white/8">
                    ...
                    <p class="mt-3 text-base leading-8 text-slate-600 dark:text-slate-400">
                        These Terms of Service govern your use of NexaHub — a virtual number and OTP activation platform. By accessing or using NexaHub, you agree to be bound by these terms in full. Please read them carefully before registering or placing any activation.
                    </p>
                </div>
                ...
                <div class="prose-nexahub space-y-14">
                    ...
                    <section id="overview">
                        ...
                        <div class="space-y-4 text-slate-600 dark:text-slate-400 leading-8">
                            <p>NexaHub is a virtual number and SMS verification platform. We provide temporary, real phone numbers that can receive SMS messages, enabling users to complete OTP-based verification flows for third-party platforms and services.</p>
                            <p>NexaHub provides the following core service categories:</p>
                            <ul class="list-disc pl-6 space-y-2">
                                ...
                                <li><strong class="text-slate-800 dark:text-slate-200">Receive SMS Service:</strong> Live SMS inbox service allowing users to receive all incoming messages on a virtual number in real time through the NexaHub dashboard.</li>
                            ...
                            <p>NexaHub is a technology intermediary and is not affiliated with, endorsed by, or partnered with any of the platforms whose verification services users access through our numbers. We reserve the right to modify, suspend, or discontinue any service at any time.</p>
                        </div>
                    </section>
                    ...
                    <section id="acceptable-use">
                        ...
                        <div class="space-y-4 text-slate-600 dark:text-slate-400 leading-8">
                            <p>NexaHub may be used for the following legitimate purposes:</p>
                            <ul class="list-disc pl-6 space-y-2">
                                ...
                                <li>Reselling virtual number activations to end users via the NexaHub API, provided your use complies with these terms.</li>
                            </ul>
                            <p>By using NexaHub, you represent that you are at least 18 years old, have the legal capacity to enter into these terms, and are not located in a jurisdiction where the use of virtual number services is prohibited.</p>
                        </div>
                    </section>
                        ...
                        <div class="space-y-4 text-slate-600 dark:text-slate-400 leading-8">
                            ...
                            <div class="space-y-3">
                                <div class="rounded-2xl border border-red-100 dark:border-red-500/20 bg-red-50 dark:bg-red-500/8 px-5 py-4">
                                    ...
                                    <p class="text-sm text-red-700 dark:text-red-400">Using NexaHub to create mass accounts on any platform for the purpose of spamming, boosting, vote manipulation, or artificially inflating metrics. Creating more than one account per platform for deceptive purposes is prohibited.</p>
                                </div>
                                <div class="rounded-2xl border border-red-100 dark:border-red-500/20 bg-red-50 dark:bg-red-500/8 px-5 py-4">
                                ...
                                <div class="rounded-2xl border border-red-100 dark:border-red-500/20 bg-red-50 dark:bg-red-500/8 px-5 py-4">
                                    ...
                                    <p class="text-sm text-red-700 dark:text-red-400">Using NexaHub to facilitate money laundering, cryptocurrency scams, Ponzi schemes, unauthorized access to financial accounts, or any other financial crime.</p>
                                </div>
                                <div class="rounded-2xl border border-red-100 dark:border-red-500/20 bg-red-50 dark:bg-red-500/8 px-5 py-4">
                                    <p class="text-sm font-bold text-red-800 dark:text-red-300 mb-1">Abuse of Target Platforms</p>
                                    <p class="text-sm text-red-700 dark:text-red-400">Using NexaHub to circumvent security systems, bans, or restrictions imposed by third-party platforms in a manner that violates those platforms' terms of service in a harmful or malicious way.</p>
                                </div>
                                <div class="rounded-2xl border border-red-100 dark:border-red-500/20 bg-red-50 dark:bg-red-500/8 px-5 py-4">
                            ...
                            <p>NexaHub operates automated abuse detection systems. Accounts engaging in prohibited activities will be suspended without refund. NexaHub cooperates fully with law enforcement upon lawful request.</p>
                        </div>
                    </section>
                    ...
                    <section id="numbers-otp">
                        ...
                        <div class="space-y-4 text-slate-600 dark:text-slate-400 leading-8">
                            <p>Virtual numbers provided by NexaHub are subject to the following conditions:</p>
                            <ul class="list-disc pl-6 space-y-2">
                                ...
                                <li><strong class="text-slate-800 dark:text-slate-200">Third-party Dependency:</strong> OTP delivery depends on the target platform sending the SMS. NexaHub is not responsible for delays, failures, or blocks caused by the target platform's systems, spam filters, or policies.</li>
                                ...
                                <li><strong class="text-slate-800 dark:text-slate-200">Number Availability:</strong> Number availability by country and service may vary based on our provider pool. NexaHub does not guarantee availability for any specific service or country at any given time.</li>
                            ...
                            <div class="rounded-2xl border border-violet-200 dark:border-violet-500/20 bg-violet-50 dark:bg-violet-500/8 px-5 py-4">
                                ...
                                <p class="text-sm text-violet-700 dark:text-violet-400">NexaHub sources numbers from third-party telecoms providers. While we rigorously vet our providers, we cannot be held liable for number quality issues, delayed message delivery, or provider-side outages beyond our control.</p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section id="receive-sms">
                        ...
                        <div class="space-y-4 text-slate-600 dark:text-slate-400 leading-8">
                            <p>NexaHub's Receive SMS service provides virtual numbers with a live SMS inbox. Use of this service is subject to additional conditions:</p>
                            <ul class="list-disc pl-6 space-y-2">
                                <li><strong class="text-slate-800 dark:text-slate-200">Temporary Numbers:</strong> Numbers provided for Receive SMS are temporary and may be recycled after your session ends. NexaHub does not guarantee that a number remains exclusively yours beyond the active rental window.</li>
                                ...
                                <li><strong class="text-slate-800 dark:text-slate-200">No Guaranteed Delivery:</strong> While NexaHub delivers the vast majority of incoming SMS, delivery depends on third-party telecoms networks. NexaHub is not liable for messages not delivered due to sender-side or carrier-side issues.</li>
                    ...
                    <section id="anti-spam">
                        ...
                        <div class="space-y-4 text-slate-600 dark:text-slate-400 leading-8">
                            <p>NexaHub maintains a strict zero-tolerance policy on spam and abusive messaging facilitated through our platform:</p>
                            ...
                            <div class="rounded-2xl border border-orange-100 dark:border-orange-500/20 bg-orange-50 dark:bg-orange-500/8 px-5 py-4">
                                ...
                                <p class="text-sm text-orange-700 dark:text-orange-400">Using NexaHub to create virtual numbers or SMS inboxes for the purpose of sending, receiving, or facilitating spam — including unsolicited marketing, phishing attempts, or bulk unsolicited messages — is strictly prohibited and will result in permanent account termination.</p>
                            </div>
                            ...
                            <ul class="list-disc pl-6 space-y-2">
                                ...
                                <li>Reselling access to NexaHub SMS inboxes for use in spam or bulk messaging campaigns.</li>
                                <li>Using NexaHub services in connection with smishing (SMS phishing) attacks, vishing, or social engineering campaigns.</li>
                                <li>Automating the Receive SMS service to systematically collect or scrape incoming message content.</li>
                            </ul>

                            <p>NexaHub reserves the right to implement automated detection systems to identify patterns consistent with spam or abusive use. Accounts flagged by these systems may be suspended pending review without prior notice.</p>
                        </div>
                    </section>
                    ...
                    <section id="refunds">
                        ...
                        <div class="space-y-4 text-slate-600 dark:text-slate-400 leading-8">
                            ...
                            <p>All refunds are credited to your NexaHub wallet balance. We do not issue refunds to external payment methods or bank accounts.</p>
                        </div>
                    </section>
                    ...
                    <section id="payments">
                        ...
                        <div class="space-y-4 text-slate-600 dark:text-slate-400 leading-8">
                            <p>NexaHub operates a pre-funded wallet system. You must deposit balance before purchasing activations.</p>
                            <ul class="list-disc pl-6 space-y-2">
                    ...
                    <section id="api">
                        ...
                        <div class="space-y-4 text-slate-600 dark:text-slate-400 leading-8">
                            <p>Access to NexaHub's REST API is subject to the following conditions:</p>
                            <ul class="list-disc pl-6 space-y-2">
                                ...
                                <li>NexaHub reserves the right to revoke API access for terms violations without prior notice.</li>
                    ...
                    <section id="termination">
                        ...
                        <div class="space-y-4 text-slate-600 dark:text-slate-400 leading-8">
                            <p>NexaHub reserves the right to restrict, suspend, or permanently terminate accounts in the following circumstances:</p>
                            <ul class="list-disc pl-6 space-y-2">
                                ...
                                <li>Attempting to reverse-engineer, scrape, or exploit the NexaHub platform or API.</li>
                                <li>Creating multiple accounts to circumvent bans, spend limits, or promotional restrictions.</li>
                                <li>Any activity that NexaHub determines, in its sole discretion, is harmful to the platform, other users, or third-party platforms.</li>
                            </ul>
                    ...
                    <section id="liability">
                        ...
                        <div class="space-y-4 text-slate-600 dark:text-slate-400 leading-8">
                            ...
                            <ul class="list-disc pl-6 space-y-2">
                                <li>NexaHub is not liable for actions taken by third-party platforms in response to the use of our virtual numbers, including account bans, suspensions, or content removal.</li>
                                <li>NexaHub is not responsible for OTP delivery failures caused by the target platform's own SMS blocking, spam filters, or system outages.</li>
                                <li>NexaHub is not liable for indirect, incidental, special, consequential, or punitive damages arising from use of the platform.</li>
                                <li>NexaHub's total aggregate liability for any claim relating to the platform is limited to the amount paid by you for activations in the 30 days prior to the claim.</li>
                                <li>NexaHub provides the platform "as is" and "as available" without warranties of any kind, express or implied.</li>
                            </ul>
                    ...
                    <div class="pt-8 border-t border-slate-100 dark:border-white/8">
                        <p class="text-sm text-slate-500 dark:text-slate-400 leading-7">
                            These Terms of Service were last updated in May 2026. NexaHub may update these terms periodically. Continued use of the platform following notice of changes constitutes acceptance of the revised terms. For questions,
