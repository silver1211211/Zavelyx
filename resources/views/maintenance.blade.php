@php
    ...
    $description = $message ?? 'We\'re performing scheduled maintenance to improve your experience.';
    ...
    $actions = [
        ...
        ['type' => 'link',    'label' => 'Contact Support', 'href' => 'mailto:support@zavelyx.com', 'icon' => ''],
    ];
@endphp
